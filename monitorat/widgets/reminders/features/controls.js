class RemindersControls {
  ...
  initializeSourceFilter () {
    const sourceSelect = this.widget.container.querySelector('.reminders-source-filter')
  ...
  updateSources (sources, selectedSource) {
    ...
    this.sourceSelect.value = selectedSource && selectedSource !== 'all' ? selectedSource : 'all'
