...
async function showMenuModal() {
  ...
  const content = `
    <div class="menu-modal-controls">
      ...
      ${
        editingAvailable
          ? `<button type="button" class="menu-modal-control" id="menu-edit-toggle">
            ...
            <span class="menu-modal-label">${editModeEnabled ? 'Done with Editing' : 'Use Editor'}</span>
          </button>`
          : ''
      }
      ...
      <button type="button" class="menu-modal-control" id="menu-notifications">
        <span class="menu-modal-icon">${MENU_ICONS.bell}</span>
        <span class="menu-modal-label">Test Notification</span>
      </button>
    </div>
  ...
  document
    .getElementById('menu-notifications')
    ?.addEventListener('click', async () => {
      const resultsContainer = document.getElementById(
        'notification-test-results',
      );
      const resultsList = document.getElementById('notification-results-list');
