#!/usr/bin/env python3
"""
Production-ready launcher for the monitor@ demo.
...
Usage:
    ...
    python demo/launcher.py --central-only     # Start only central
    python demo/launcher.py --background       # Daemonize (for production)
